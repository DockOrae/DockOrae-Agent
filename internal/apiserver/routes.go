...
func (s *Server) registerRoutes() {
	...
	// ---------- 宿主文件(§55) ----------
	s.register("GET", "/v1/host/files/list", s.handleFilesList)
	s.register("GET", "/v1/host/files/dirsize", s.handleFilesDirSize)
	s.register("POST", "/v1/host/files/chown", s.handleFilesChown)
	s.register("GET", "/v1/host/files/stat", s.handleFilesStat)
	s.register("POST", "/v1/host/files/touch", s.handleFilesTouch)
	s.register("POST", "/v1/host/files/mkdir", s.handleFilesMkdir)
	s.register("POST", "/v1/host/files/rename", s.handleFilesRename)
	s.register("POST", "/v1/host/files/copy", s.handleFilesCopy)
	s.register("POST", "/v1/host/files/move", s.handleFilesMove)
	s.register("POST", "/v1/host/files/remove", s.handleFilesRemove)
	s.register("POST", "/v1/host/files/chmod", s.handleFilesChmod)
	s.register("POST", "/v1/host/files/write", s.handleFilesWrite)
	s.register("POST", "/v1/host/files/upload", s.handleFilesUpload)
	s.register("GET", "/v1/host/files/download", s.handleFilesDownload)
	s.register("POST", "/v1/host/files/compress", s.handleFilesCompress)
	s.register("POST", "/v1/host/files/extract", s.handleFilesExtract)
	s.register("GET", "/v1/host/files/search", s.handleFilesSearch)
	s.register("GET", "/v1/host/files/trash/status", s.handleTrashStatus)
	s.register("POST", "/v1/host/files/trash/enable", s.handleTrashSetEnabled)
	s.register("GET", "/v1/host/files/trash/list", s.handleTrashList)
	s.register("POST", "/v1/host/files/trash/restore", s.handleTrashRestore)
	s.register("POST", "/v1/host/files/trash/delete", s.handleTrashDelete)
	s.register("POST", "/v1/host/files/trash/empty", s.handleTrashEmpty)
	...
	s.registerWS("GET", "/v1/host/terminal/ws", s.handleHostTerminalWS)
}
